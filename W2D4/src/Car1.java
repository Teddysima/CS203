public class Car1 extends Automobile1 {

	private boolean convertable;
	private int trunkCapacity;


	Car1(String mark, String model, int year, String color,
	...
	Car1(String make, String model, int year, String color, int trunkCapacity) {
		this(make, model, year, color, false, trunkCapacity);
	}

	Car1(String make, String model, int trunkCapacity) {
