...
public class CorporateCar2 extends Vehicle implements Asset2 {
	...
	public CorporateCar2(int x, int y, int direction, int price, int value,
	...
	public CorporateCar2(int price, int value, int year, String employee){
		this(0, 0, 0, price,value, year, employee);
		System.out.println("CorporareCar2(4 params) called");
	}
	public CorporateCar2(int price, int value){
